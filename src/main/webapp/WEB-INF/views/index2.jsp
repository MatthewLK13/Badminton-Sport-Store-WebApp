   ...
   <section class="spotlight-section">
    ...
    <div class="spotlight-grid">
        ...
        <div class="spotlight-card">
            <img src="${pageContext.request.contextPath}/images/image2.png" alt="Isometric">
        ...
        <div class="spotlight-card">
            <img src="${pageContext.request.contextPath}/images/image3.png" alt="From Miles to Match">
            <div class="card-content">
        ...
        <div class="spotlight-card">
            <img src="${pageContext.request.contextPath}/images/image4.png" alt="Performance Apparel">
            <div class="card-content">
    ...
    <div class="spotlight-large-banner">
        <img src="${pageContext.request.contextPath}/images/image5.png" alt="Gear up and go">
        ...
        <div class="athletes-row">
            <div class="athlete-card">
                <div class="athlete-img-wrapper">
                   <a href="${pageContext.request.contextPath}/athlete/an-se-young.htm">
    <img src="${pageContext.request.contextPath}/images/image10.png" class="img-base" alt="An Se-young">
    <img src="${pageContext.request.contextPath}/images/image14.png" class="img-hover" alt="An Se-young Hover">
</a>
                </div>
            </div>
            <div class="athlete-card">
                <div class="athlete-img-wrapper">
                   <a href="${pageContext.request.contextPath}/athlete/kento-momota.htm">
    <img src="${pageContext.request.contextPath}/images/image11.png" class="img-base" alt="An Se-young">
    <img src="${pageContext.request.contextPath}/images/image15.png" class="img-hover" alt="An Se-young Hover">
</a>
                </div>
            </div>
        </div>

       <div class="athletes-row" style="justify-content: center;">
    <div class="athlete-card" style="flex: 0 0 50%; max-width: 50%;">
        <div class="athlete-img-wrapper">
            <a href="${pageContext.request.contextPath}/athlete/seo-chae.htm" style="display: block;">
                <img src="${pageContext.request.contextPath}/images/image12.png" class="img-base">
                <img src="${pageContext.request.contextPath}/images/image16.png" class="img-hover">
            </a>
        </div>
    </div>
</div>
...
<div class="brand-footer">
    <img src="${pageContext.request.contextPath}/images/image13.png" class="footer-logo">
</div>
